...
public class BreezyLog extends BlockRotatedPillar
{
    /** The type of tree this log came from. */
    public static final String[] woodType = new String[] {"breezy"};
    @SideOnly(Side.CLIENT)
    private Icon[] field_111052_c;
    @SideOnly(Side.CLIENT)
    private Icon[] tree_top;

    protected BreezyLog(int par1)
    {
    ...
    {
        return 	TribesMod.breezyLog.blockID;
    }
