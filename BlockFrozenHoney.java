...
public class BlockFrozenHoney extends BlockBreakable
{

	public BlockFrozenHoney(int par1)
	{
		super(par1, "frozenHoney", Material.ice, false);
		this.setTextureName("tribesmod:frozenHoney");
    ...
    public void harvestBlock(World par1World, EntityPlayer par2EntityPlayer, int par3, int par4, int par5, int par6)
    {
        ...
        else
        {
            ...
            {
                par1World.setBlock(par3, par4, par5, TribesMod.blockHoney.blockID);
            }
        }
    }
	...
	public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        if (par1World.getSavedLightValue(EnumSkyBlock.Block, par2, par3, par4) > 11 - Block.lightOpacity[this.blockID])
        {
            ...
            par1World.setBlock(par2, par3, par4, TribesMod.blockHoney.blockID);
        }
    }
}
