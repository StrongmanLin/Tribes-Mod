...
public class WorldGenBreezyTrees extends WorldGenerator
{
    ...
    public WorldGenBreezyTrees(boolean par1)
    {
        this(par1, 4);
    }

    public WorldGenBreezyTrees(boolean par1, int par2)
    {
        super(par1);
                ...
                for (int l1 = par3 - b0; l1 <= par3 + b0 && flag; ++l1)
                {
                    for (j1 = par5 - b0; j1 <= par5 + b0 && flag; ++j1)
                    {
                        if (i1 >= 0 && i1 < 256)
                        {
                            ...
                            if (!par1World.isAirBlock(l1, i1, j1) && !block.isLeaves(par1World, l1, i1, j1) && k1 != TribesMod.breezyGrass.blockID && k1 != TribesMod.breezyDirt.blockID && !block.isWood(par1World, l1, i1, j1))
                            {
                                flag = false;
                            }
                        }
            ...
            else
            {
                ...
                if (isSoil && par4 < 256 - l - 1)
                {
                        ...
                        for (j2 = par3 - i2; j2 <= par3 + i2; ++j2)
                        {
                            ...
                            for (int l2 = par5 - i2; l2 <= par5 + i2; ++l2)
                            {
                                ...
                                if (Math.abs(k2) != i2 || Math.abs(i3) != i2 || par2Random.nextInt(2) != 0 && k1 != 0)
                                {
                                    ...
                                    {
                                        this.setBlockAndMetadata(par1World, j2, j1, l2, TribesMod.breezyLeaf.blockID, this.metaLeaves);
                                    }
                                }
                            }
                        }
                    ...
                    for (j1 = 0; j1 < l; ++j1)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, par3, par4 + j1, par5, TribesMod.breezyLog.blockID, this.metaWood);
