...
public class ItemElementalArmor extends ItemArmor
{
	...
	public ItemElementalArmor(int i, EnumArmorMaterial material, int j, int type, String name)
	{
	...
	private void setTextureName(String type, int part)
	{
		if(part == 0 || part == 1 || part == 3)
			this.texturePath += "elemental" + "_layer_1.png";
		else
			this.texturePath += "elemental" + "_layer_2.png";
	}
