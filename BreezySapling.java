...
public class BreezySapling extends BlockFlower
{
    public static final String[] 	WOOD_TYPES = new String[] {"breezy"};
    @SideOnly(Side.CLIENT)
    private Icon[] saplingIcon;

    protected BreezySapling(int par1)
    {
        super(par1);
        float f = 0.4F;
    ...
    public void growTree(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        else if (l == 3)
        {
            ...
            if (object == null)
            {
                j1 = 0;
                i1 = 0;
                object = new WorldGenBreezyTrees(true, 4 + par5Random.nextInt(7));
            }
        }
        else
        {
            object = new WorldGenBreezyTrees(true);
