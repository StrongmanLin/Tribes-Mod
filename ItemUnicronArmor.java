...
public class ItemUnicronArmor extends ItemArmor
{
	private String texturePath = "tribesmod:textures/model/armor/";
	
	public ItemUnicronArmor(int i, EnumArmorMaterial material, int j, int type, String name)
	{
	...
	private void setTextureName(String type, int part)
	{
		if(part == 0 || part == 1 || part == 3)
			this.texturePath += "unicron" + "_layer_1.png";
		else
			this.texturePath += "unicron" + "_layer_2.png";
	}
