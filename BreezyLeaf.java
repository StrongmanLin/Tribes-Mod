...
public class BreezyLeaf extends BlockLeavesBase implements IShearable
{
    public static final String[] LEAF_TYPES = new String[] {"breezy"};
    public static final String[][] field_94396_b = new String[][] {{"leaves_breezy"}, {"leaves_breezy_opaque"}};
    ...
    {
        return TribesMod.breezySapling.blockID;
    }
