...
public class ChunkProviderBreezy implements IChunkProvider
{
    /** RNG. */
    private Random rand;
    ...
    public ChunkProviderBreezy(World par1World, long par2, boolean par4)
    {
                    ...
                    for (int l1 = 0; l1 < 8; ++l1)
                    {
                        ...
                        for (int i2 = 0; i2 < 4; ++i2)
                        {
                            ...
                            for (int k2 = 0; k2 < 4; ++k2)
                            {
                                if ((d16 += d15) > 0.0D)
                                {
                                    par3ArrayOfByte[j2 += short1] = (byte)TribesMod.breezyStone.blockID;
                                }
                                else if (k1 * 8 + l1 < b2)
                                {
                                    par3ArrayOfByte[j2 += short1] = (byte)TribesMod.blockHoney.blockID;
                                }
                                else
                                {
	    	...
	    	for (int var9 = 0; var9 < 16; var9++)
	   		{
		    	...
		    	for (int var16 = 127; var16 >= 0; var16--)
		    	{
	    	         ...
	    	         else
	    	         {
	    	        	 ...
	    	        	 else if (var18 != TribesMod.breezyStone.blockID)
	    	        	 {
	    	        		 if (var13 == -1)
	    	        		 {
	    	        			 if (var12 == 0)
	    	        			 {
	    	        				 ...
	    	        				 var15 = (byte)TribesMod.breezyDirt.blockID;//
	    	        			 }
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
            ...
            && TerrainGen.populate(par1IChunkProvider, worldObj, rand, par2, par3, flag, LAKE))
        {
            ...
            (new WorldGenLakes(TribesMod.blockHoney.blockID)).generate(this.worldObj, this.rand, k1, l1, i2);
        }
        ...
        for (k1 = 0; doGen && k1 < 16; ++k1)
        {
            for (l1 = 0; l1 < 16; ++l1)
            {
                ...
                {
                    this.worldObj.setBlock(k1 + k, i2 - 1, l1 + l, TribesMod.frozenHoney.blockID, 0, 2);
                }

                if (this.worldObj.canSnowAt(k1 + k, i2, l1 + l))
                {
                    this.worldObj.setBlock(k1 + k, i2, l1 + l, TribesMod.powderedSugar.blockID, 0, 2);
                }
            }
        }
